...
class PlanningGraph():
    ...
    def interference_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        def is_mutex(node_a1, node_a2):
            return any([effect in node_a2.action.precond_neg for effect in node_a1.action.effect_add]) or \
                   any([effect in node_a2.action.precond_pos for effect in node_a1.action.effect_rem])

        return is_mutex(node_a1, node_a2) or is_mutex(node_a2, node_a1)
    ...
    def competing_needs_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        :return: bool
        """
        return any([parent1.is_mutex(parent2) for parent2 in node_a2.parents for parent1 in node_a1.parents])
    ...
    def inconsistent_support_mutex(self, node_s1: PgNode_s, node_s2: PgNode_s):
        ...
        :return: bool
        """
        return all([parent1.is_mutex(parent2) for parent2 in node_s2.parents for parent1 in node_s1.parents])
    ...
    def h_levelsum(self) -> int:
        ...
        for goal in self.problem.goal:
            ...
            for ix, s_level in enumerate(self.s_levels):
                if node in s_level:
                    level_sum += ix
                    break
